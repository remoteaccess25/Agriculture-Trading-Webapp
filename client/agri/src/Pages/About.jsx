      ...
      <div className="abouPage_main_div">
        <div className="about_div1">
          <div className="about_left_div">
            <div className="context_div1">
              Welcome to Team Harvest Hub! We are a dynamic and innovative group
              dedicated to revolutionizing the way we approach agriculture and
              food production.
            </div>
            <div className="context_div2">
              Together we strive for the better quality of life of the
              farmers...
            </div>
          </div>
        ...
        <div className="team_div">
          <div className="team_left_div">
            ...
            >
              <Team_cards
                ...
                name={"Onkar"}
                linkdinLink={
                  "https://www.linkedin.com/in/onkar-kakade-465bb5229"
                }
                instaLink={"https://instagram.com/onkar_kakade29"}
              />
            </div>
            ...
            <div className="padekar_div" data-aos={"fade-right"}>
              <Team_cards
                ...
                linkdinLink={
                  "https://www.linkedin.com/in/aditya-padekar-296522224"
                }
                instaLink={"https://instagram.com/adityapadekar"}
              />
            </div>
          </div>
          ...
          <div className="vertical_line">
            <div
              className="achievement_container cricle1"
              data-aos={"flip-up"}
            ></div>
            <div
            ...
            ></div>
            <div
              className="achievement_container cricle2"
              data-aos={"flip-up"}
            ></div>
            <div
            ...
            ></div>
            <div
              className="achievement_container cricle3"
              data-aos={"flip-up"}
            ></div>
            <div
            ...
            ></div>
            <div
              className="achievement_container cricle4"
              data-aos={"flip-up"}
            ></div>
            <div
          ...
          <div className="team_right_div">
            ...
            <div className="pratik_div" data-aos={"fade-left"}>
              <Team_cards
                ...
                linkdinLink={
                  "https://www.linkedin.com/in/pratik-pawar-40975524b"
                }
                instaLink={"https://instagram.com/pratik_0309"}
              />
            </div>
            ...
            <div className="abhinav_div" data-aos={"fade-left"}>
              <Team_cards
                ...
                instaLink={"https://instagram.com/abhiz_2803"}
              />
            </div>
          </div>
        </div>
